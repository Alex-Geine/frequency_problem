...
// frequency_problem.cpp: определяет поведение классов для приложения.
//
...
// CfrequencyproblemApp

BEGIN_MESSAGE_MAP(CfrequencyproblemApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CfrequencyproblemApp

CfrequencyproblemApp::CfrequencyproblemApp()
{
...
// Единственный объект CfrequencyproblemApp

CfrequencyproblemApp theApp;


// Инициализация CfrequencyproblemApp

BOOL CfrequencyproblemApp::InitInstance()
{
